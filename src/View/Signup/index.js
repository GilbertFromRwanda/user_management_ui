...
function Signup() {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("martalStatus", userData.maritalStatus);
    formData.append("nationality", userData.nationality);
    formData.append("birthDate", userData.birthDate);
    formData.append("age", age);
    setIsloading(true);
    axios
      .post(`${API_URL}/auth/email/register`, formData)
      .then((response) => {
    ...
    // dispatch(createdAccount({ formData }));
    // formData.append("nationalIdNumber","");
    // formData.append("accountStatus","");
    // formData.append("doc_image","");
  };
